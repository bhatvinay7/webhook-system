...
Stripe Payments was losing webhooks when services crashed mid-delivery. When the payment API crashed while sending webhooks to Svix:
...
**Blog Post**: [Building Reliable Webhooks at Scale](https://stripe.dev/blog/reliable-webhooks)
